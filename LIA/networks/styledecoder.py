...
import numpy as np
from .custom_op import qr_decomposition, diag_embedding
...
def upfirdn2d_native(input, kernel, up_x, up_y, down_x, down_y, pad_x0, pad_x1, pad_y0, pad_y1):
    ...
    out = out.reshape([minor, 1, in_h * up_y + pad_y0 + pad_y1, in_w * up_x + pad_x0 + pad_x1])
...
class ToFlow(nn.Module):
    ...
    def forward(self, input, style, feat, skip=None):
        ...
        feat_warp = bilinear_grid_sample(feat, flow) * mask
